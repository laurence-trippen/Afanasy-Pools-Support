...
class MongoDB():
    ...
    def connect(self, connection):
        try:
            ...
            MongoDB.status = ">> Database connection established."
        except:
            MongoDB.status = ">> Database connection failed."

        self.afpools_db = self.client[MongoDB.POOLS_DATABSE]
        self.pools_col = self.afpools_db[MongoDB.POOLS_COLLECTION]
